...
const tokensField = document.getElementById("tokens_field")
const activatePhoneField = document.getElementById("activate_phone_field")
const activateEmailField = document.getElementById("activate_email_field")
